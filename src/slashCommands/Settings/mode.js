 ...
 const player = client.manager.players.get(interaction.guild.id);
        ...
        let data = await db.findOne({Guild: interaction.guild.id})
            ...
            let thing = new MessageEmbed()
              ...
              .setAuthor({ name: `${client.user.username} - Modes`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setDescription(`Current Radio Mode: **${mode}**`)
      ...
      if (!i.deferred) i.deferUpdate();
        ...
        if (i.customId === 'two') {
         ...
         let slp = new MessageEmbed()
           .setAuthor({ name: `${client.user.username} - Modes`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setColor(client.embedColor)
                .setDescription(`Current Radio Mode: **24/7** `)
      ...
      await newData.save()
        ...
        if (i.customId === 'auto') {
         ...
         let slp = new MessageEmbed()
                .setColor(client.embedColor)
           .setAuthor({ name: `${client.user.username} - Modes`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setDescription(`Current Radio Mode: **Auto Play** `)
...
interaction.editReply({ embeds: [slp], components:[row4] })
      ...
      await newData.save()
         ...
         let slp = new MessageEmbed()
                .setColor(client.embedColor)
           .setAuthor({ name: `${client.user.username} - Modes`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setDescription(`Current Radio Mode: **Session** `)
...
interaction.editReply({ embeds: [slp], components:[row4] })
      ...
      await newData.save()
         ...
         let slp = new MessageEmbed()
           .setAuthor({ name: `${client.user.username} - Help`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setColor(client.embedColor)
           
                .setDescription(`
                **Radio Modes**
**Session:** Kinda like disabling the modes
**Auto Play:** Auto plays songs.
