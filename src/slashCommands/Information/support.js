...
module.exports = {
  name: 'support',
  description: 'Send invitation to join DJ Mimo support server',
  userPrams: [],
  ...
  run: async (client, interaction) => {
    ...
    const embed = new MessageEmbed()
      .setAuthor({ name: `${client.user.username} support server`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
