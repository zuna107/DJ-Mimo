...
const ress = await db1.findOne({ Guild: interaction.guildId });
    if (ress && ress.Radio) station = ress.Radio;
          ...
          .setAuthor({ name: `${client.user.username}`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                .setDescription(`
                Sleep Timer lets you fall asleep to songs from DJ Mimo. At the end of the countdown DJ Mimo will disconnect you from the sound channel, so you can sleep soundly and stop battery drain.
...
if (options === 'half') {
        ...
        let thing = new MessageEmbed()
          ...
          .setAuthor({ name: `${client.user.username}`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
                ...
                Sleep Timer lets you fall asleep to songs from DJ Mimo. At the end of the countdown DJ Mimo will disconnect you from the sound channel, so you can sleep soundly and stop battery drain.
                <:timer:1121732448670199879> **Timer Status**
                **${interaction.member} will be removed after \`30 minutes\`**
                `)
    ...
    components: [row3]
        ...
        let thing = new MessageEmbed()
          ...
          .setAuthor({ name: `${client.user.username}`, iconURL: client.user.displayAvatarURL(), url: `https://discord.gg/MwV9tm6RPX` })
             ...
             Sleep Timer lets you fall asleep to songs from DJ Mimo. At the end of the countdown DJ Mimo will disconnect you from the sound channel, so you can sleep soundly and stop battery drain.
                <:timer:1121732448670199879> **Timer Status**
                **${interaction.member} will be removed after \`1 Hours\`**
                `)
  ...
  if (options === 'onehalf') {
        ...
        let thing = new MessageEmbed()
          ...
          .setDescription(`
                Sleep Timer lets you fall asleep to songs from DJ Mimo. At the end of the countdown DJ Mimo will disconnect you from the sound channel, so you can sleep soundly and stop battery drain.
                <:timer:1121732448670199879> **Timer Status**
                **${interaction.member} will be removed after \`1 Hour 30 minutes\`**
                `)
    ...
    components: [row3]
        ...
        let thing = new MessageEmbed()
          ...
          .setDescription(`
                Sleep Timer lets you fall asleep to songs from DJ Mimo. At the end of the countdown DJ Mimo will disconnect you from the sound channel, so you can sleep soundly and stop battery drain.
                <:timer:1121732448670199879> **Timer Status**
                **${interaction.member} will be removed after \`2 Hours\`**
                `)
