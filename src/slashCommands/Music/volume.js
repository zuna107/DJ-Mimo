...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!player.queue.current) {
      let thing = new MessageEmbed().setColor(client.embedColor).setDescription('There is no music playing.');
        ...
        .editReply({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(`
              **Invalid volume has been provided!**
              Use /volume <0 - 100>`),
          ],
        })
    }
    ...
    if (volume > player.volume) {
      let thing = new MessageEmbed()
        .setColor(client.embedColor)
        .setDescription(`
              ** Successfully volume has been changed!**
