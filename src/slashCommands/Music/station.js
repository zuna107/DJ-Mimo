 ...
 const row = new MessageActionRow()
      .addComponents(
        new MessageSelectMenu()
          ...
          .addOptions([
            {
              label: 'Genshin Impact Album',
              value: 'anime',
              emoji: '🌠',
            },
            {
              label: ' Honkai: Star Rail Album',
              value: 'sleep',
              emoji: '🚄',
            },
            {
              label: 'Honkai Impact Album',
              value: 'study',
              emoji: '🌀',
            }
          ])
...
if (options === 'anime') {
         ...
         let ani = new MessageEmbed()
                .setColor(client.embedColor)
                .setDescription(`<:radio:1119915830344437790> Current Station: **Genshin Impact Album** `)
      ...
      // await newData.save()
        ...
        if (options === 'sleep') {
         ...
         let slp = new MessageEmbed()
                .setColor(client.embedColor)
                .setDescription(`<:radio:1119915830344437790> Current Station: **Honkai: Star Rail Album** `)
  ...
  m.edit({
      ...
      await newData.save()
         ...
         let sty = new MessageEmbed()
                .setColor(client.embedColor)
                .setDescription(`<:radio:1119915830344437790> Current Station: **Honkai Impact Album** `)
